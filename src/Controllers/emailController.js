    ...
    sendEmailCheckout: async (req, res) => {
        try {
            ...
            const mailContent = `
                ...
                <p><strong>Sàn giao dịch thương mại: <i><a style='color: #ee4d2d' href='https://shopsmallnmc.netlify.app/'>MegaMart</a></i></strong></p>
    ...
    emailMarketing: async (req, res) => {
        try {
            ...
            if (!product) {
                ...
                // gửi mail cho tất cả khác hàng trong Model User
                for (let i = 0; i < userList.length; i++) {
                    const mailContent = `
                        <p>Kính gửi: <strong><i>${
                            userList[i]?.username
                        }</i></strong></p>
                        <p><i>Chúng tôi, bộ phận xử lý đơn hàng <span><a style='color: #ee4d2d' href='https://shopsmallnmc.netlify.app/'><u><strong>MEGAMART</strong></u></a></span>. Chúng tôi có một sản phẩm mới cho bạn xem.</i></p>
                        ...
                        <table style='border-collapse: collapse; width: 100%;'>
                            ...
                            <tbody>
                                <tr>
                                    <td style='border: 1px solid #ddd; padding: 8px; text-align: left; max-width: 300px; min-width: 120px;'><i><a style='color: #ee4d2d' href='https://shopsmallnmc.netlify.app/products/detail/${idProduct}'>${
                        product.name
                    }</a></i></td>
